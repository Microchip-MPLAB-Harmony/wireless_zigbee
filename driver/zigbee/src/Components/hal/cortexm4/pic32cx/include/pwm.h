...
#define INTENCLR(pwmUnit)     MMIO_REG(pwmUnit + 0x24U, uint32_t)
#define INTENSET(pwmUnit)     MMIO_REG(pwmUnit + 0x28U, uint32_t)
#define INTFLAG(pwmUnit)      MMIO_REG(pwmUnit + 0x2cU, uint32_t)
#define COUNT(pwmUnit)        MMIO_REG(pwmUnit + 0x34U, uint32_t)
#define PATT(pwmUnit)         MMIO_REG(pwmUnit + 0x38U, uint16_t)
...
#define FCTRLA(pwmUnit)       MMIO_REG(pwmUnit + 0x0CU, uint32_t)
#define FCTRLB(pwmUnit)       MMIO_REG(pwmUnit + 0x10U, uint32_t)
#define WEXCTRL(pwmUnit)      MMIO_REG(pwmUnit + 0x14U, uint32_t)
#define DBGCTRL(pwmUnit)      MMIO_REG(pwmUnit + 0x1EU, uint8_t)
#define EVCTRL(pwmUnit)       MMIO_REG(pwmUnit + 0x20U, uint32_t)
#define STATUS(pwmUnit)       MMIO_REG(pwmUnit + 0x30U, uint32_t)
#define PATTB(pwmUnit)        MMIO_REG(pwmUnit + 0x64U, uint16_t)
#define WAVEB(pwmUnit)        MMIO_REG(pwmUnit + 0x68U, uint32_t)
#define PERB(pwmUnit)         MMIO_REG(pwmUnit + 0x6cU, uint32_t)
#define CCB0(pwmUnit)         MMIO_REG(pwmUnit + 0x70U, uint32_t)
#define CCB1(pwmUnit)         MMIO_REG(pwmUnit + 0x74U, uint32_t)
#define CCB2(pwmUnit)         MMIO_REG(pwmUnit + 0x78U, uint32_t)
#define CCB3(pwmUnit)         MMIO_REG(pwmUnit + 0x7cU, uint32_t)
#define CCBx(pwmUnit,channel) MMIO_REG(pwmUnit + 0x70U + channel*4, uint32_t)
