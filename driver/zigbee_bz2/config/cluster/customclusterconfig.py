...
#############################################################################################################
    ...
    try:
        ...
        File.setSourcePath('/driver/zigbee' + suffix + '/templates/cluster/custom/zclCustomCluster.h.ftl')
        ...
        File.setSourcePath('/driver/zigbee' + suffix + '/templates/cluster/custom/zbCustomCluster.c.ftl')    
        ...
        File.setSourcePath('/driver/zigbee' + suffix + '/templates/cluster/custom/zbCustomCluster.h.ftl')    
